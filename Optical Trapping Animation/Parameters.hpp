...
#define Number_Molecules 2000   // Total number of CO molecules
#define Microtrap_Shape "Ell"   // Microtrap's shape: "Cyl" or "Ell"
...
#define Microtrap_V 4.          // Microtrap's velocity                                 [µm/µs]
#define Microtrap_T 1.          // Microtrap's temperature                              [mK]
