...
int main ()
{
        ...
        tfin=5.*(3.*IPG_WY(Chip_DY))/Microtrap_V;                       // Final time calculated as approximatively five times the period needed to reach the optical trap
        ...
        printf("%lf\t %lf\n", Microtrap_V, (float)Trapped_N/(a3pi1_N + Lost_N + GS_N) );
